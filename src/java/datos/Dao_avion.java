...
public class Dao_avion extends Dao {
    ...
    public static void editarAvion(Avion a) throws Exception {
        Connection connection = Conn.conectar();
        String call = EDITAR;
        call = String.format(call, a.getId(), a.getTipoAvion_id().getId(), a.getRuta_id().getId());
        CallableStatement cs = connection.prepareCall(call);
        cs.executeUpdate();
    }
    ...
    private static final String EDITAR = "{call editar_avion(%s,%s,%s)}";
}
